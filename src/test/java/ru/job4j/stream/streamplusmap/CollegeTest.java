...
public class CollegeTest {
    ...
    public void whenSubjectIsOptionalEmptyWithNotFoundAccount() {
        ...
        College college = new College(students);
        assertThat(college.findBySubjectByName("000010", "Sociology")).isEqualTo(Optional.empty());
    }
    ...
    public void whenSubjectIsOptionalEmptyWithFoundAccount() {
        ...
        College college = new College(students);
        assertThat(college.findBySubjectByName("000001", "Sociology")).isEqualTo(Optional.empty());
    }
    ...
    public void whenSubjectIsOptionalNotEmpty() {
        ...
        College college = new College(students);
        assertThat(college.findBySubjectByName("000002", "Sociology").get().score()).isEqualTo(65);
    }
}